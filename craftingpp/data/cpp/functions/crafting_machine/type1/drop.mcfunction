...
data remove block 0 0 0 Items[{Slot:10b}]
data remove block 0 0 0 Items[{Slot:11b}]
data remove block 0 0 0 Items[{Slot:12b}]
data remove block 0 0 0 Items[{Slot:19b}]
data remove block 0 0 0 Items[{Slot:20b}]
data remove block 0 0 0 Items[{Slot:21b}]
data remove block 0 0 0 Items[{Slot:16b}]
