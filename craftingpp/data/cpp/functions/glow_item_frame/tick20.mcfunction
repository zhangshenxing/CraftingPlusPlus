...
execute if data storage cpp:this data.Item.tag{id:"cpp:break_hand"} align xyz positioned ~.5 ~ ~.5 run function cpp:glow_item_frame/hand/break
...
execute if score #timer_200 cppValue matches 0 if data storage cpp:this data.Item.tag{id:"cpp:industrious_hand"} align xyz positioned ~.5 ~ ~.5 run function cpp:item_frame/hand/industrious
