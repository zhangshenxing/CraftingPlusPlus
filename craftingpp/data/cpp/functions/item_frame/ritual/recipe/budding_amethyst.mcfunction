...
execute if score @s cppTick matches 1 run effect give @p instant_damage 1 0 true
execute if score @s cppTick >= $ritualsTime cppConfig run function cpp:item_frame/ritual/recipe/budding_amethyst_done
