execute store result score #f cppValue run data get entity @s Pos[0] 71
execute store result score #g cppValue run data get entity @s Pos[1] 71
execute store result score #h cppValue run data get entity @s Pos[2] 71
