...
scoreboard players operation #t1 cppValue %= #71 cppValue
execute if score #t1 cppValue matches 0..1 run scoreboard players add #t1 cppValue 71
scoreboard players operation #t1 cppValue *= #71 cppValue
...
scoreboard players operation #t2 cppValue %= #71 cppValue
execute if score #t2 cppValue matches 0..1 run scoreboard players add #t2 cppValue 71
scoreboard players operation #t2 cppValue *= #71 cppValue
...
scoreboard players operation #t3 cppValue %= #71 cppValue
execute if score #t3 cppValue matches 0..1 run scoreboard players add #t3 cppValue 71
scoreboard players operation #t3 cppValue *= #71 cppValue
...
scoreboard players operation #s1 cppValue /= #71 cppValue
scoreboard players operation #s2 cppValue /= #71 cppValue
scoreboard players operation #s3 cppValue /= #71 cppValue
...
execute summon marker run function cpp:locate/locate_t1
