execute store result score #f cppValue run data get entity @s Pos[0] 7100
execute store result score #g cppValue run data get entity @s Pos[1] 7100
execute store result score #h cppValue run data get entity @s Pos[2] 7100
