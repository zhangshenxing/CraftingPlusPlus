...
data modify block ~ ~ ~ Items[{Slot:26b}].tag.Explosion.Colors append value 0
execute store result block ~ ~ ~ Items[{Slot:26b}].tag.Explosion.Colors[-1] int 1 run scoreboard players get @s cppColor
execute unless data block ~ ~ ~ Items[{Slot:17b}] run function cpp:color_palette/firework_star/done
