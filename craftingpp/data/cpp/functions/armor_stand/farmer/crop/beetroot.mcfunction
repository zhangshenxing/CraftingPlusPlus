...
setblock 1 0 0 beetroots[age=3]
loot insert 0 1 0 mine 1 0 0 mainhand
data modify storage cpp:_ temp set from block 0 1 0 Items[{id:"minecraft:beetroot_seeds"}]
...
execute at @s run setblock ~ ~ ~ beetroots
