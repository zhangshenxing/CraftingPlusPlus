...
execute in cpp:auxi run loot insert 0 1 0 loot blocks/acacia_log
data modify storage cpp:_ temp set from storage cpp:_ items[{id:"minecraft:acacia_sapling"}]
