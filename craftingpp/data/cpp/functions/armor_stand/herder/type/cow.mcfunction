...
# 堆叠
scoreboard players operation @s cpp_stack += @e[type=cow,distance=..16,tag=!cpp_animal_this] cpp_stack
execute as @e[type=cow,distance=..16,tag=!cpp_animal_this] run data modify entity @s Health set value 0f
# 挤奶
