tag @s add cpp_golem_farmer
data modify entity @s HandItems[0].id set value "minecraft:netherite_hoe"
data modify entity @s ArmorItems[3].tag.CustomModelData set value 12970131
