tag @s add cpp_golem_fisher
data modify entity @s HandItems[0].id set value "minecraft:fishing_rod"
data modify entity @s ArmorItems[3].tag.CustomModelData set value 12970133
tp ~ ~1 ~
